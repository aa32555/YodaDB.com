...
<template>
  <div class="q-pa-md">
    <div style="padding:5px">
      ...
      <q-btn
       id="btn-go-back"
        ...
        :class="$q.dark.isActive?'bg-green':'bg-black'"
        size="md"
        icon="arrow_back"
        :color="'primary'"
    ...
    <q-card v-if="processAlive">
      <q-tabs v-model="tab" dense :class="$q.dark.isActive?'bg-green text-white shadow-2':'bg-black text-white shadow-2'">
      ...
      <q-tab-panels v-model="tab" animated id="tab_panel">
        <q-tab-panel name="details" id="details_panel">
          <div :class="$q.dark.isActive?'text-h6 text-yellow':'text-h6 text-green'">
