...
<template>
  <div class="q-pa-md" :key="pageKey" id="gdediv">
    <div style="padding:5px">
      ...
      <span :class="$q.dark.isActive?'text-yellow':'text-green'" style="font-size:28px;padding:25px" id="gde_header"
      ...
      >
        ...
        <template v-slot:top>
          <div
            :class="
              $q.dark.isActive
                ? 'bg-green text-white row'
                : 'bg-black text-white row'
            "
            style="width:100%"
          >
    ...
    <q-dialog v-model="addStatusDialog">
      <q-card id="gde_add_status_dialog">
        <q-bar :class="!$q.dark.isActive ? 'bg-black' : 'bg-green'">
